<template>
    <div class="finnish-spitz-page">
        <h1 class="title">Finnish Spitz: The National Dog of Finland</h1>
        ...
        <h2>Socialization and Training</h2>
        <p>
            ...
            people, animals, and environments from a young age can help prevent unwanted behaviors and ensure they grow up to
            be well-rounded, confident dogs.
        </p>

        <h2>Exercise and Grooming</h2>
        <p>
